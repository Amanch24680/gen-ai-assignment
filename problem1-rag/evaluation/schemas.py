...
class EvaluationQuestionResult(BaseModel):
    ...
    hit_rate_at_1: float = Field(default=0.0, description="Hit Rate@1 metric")
    hit_rate_at_3: float = Field(default=0.0, description="Hit Rate@3 metric")
    hit_rate_at_5: float = Field(default=0.0, description="Hit Rate@5 metric")
    ndcg_at_1: float = Field(default=0.0, description="nDCG@1 metric")
    ndcg_at_3: float = Field(default=0.0, description="nDCG@3 metric")
    ndcg_at_5: float = Field(default=0.0, description="nDCG@5 metric")
    reciprocal_rank: float = Field(default=0.0, description="Reciprocal Rank metric")
    retrieval_latency_ms: float = Field(default=0.0, description="Retrieval latency in milliseconds")
...
class RetrievalEvaluationSummary(BaseModel):
    ...
    hit_rate_at_1: float = Field(default=0.0, description="Mean Hit Rate@1 across answerable cases")
    hit_rate_at_3: float = Field(default=0.0, description="Mean Hit Rate@3 across answerable cases")
    hit_rate_at_5: float = Field(default=0.0, description="Mean Hit Rate@5 across answerable cases")
    ndcg_at_1: float = Field(default=0.0, description="Mean nDCG@1 across answerable cases")
    ndcg_at_3: float = Field(default=0.0, description="Mean nDCG@3 across answerable cases")
    ndcg_at_5: float = Field(default=0.0, description="Mean nDCG@5 across answerable cases")
    mrr: float = Field(description="Mean Reciprocal Rank (MRR) across answerable cases")
    p50_retrieval_latency_ms: float = Field(default=0.0, description="p50 (median) retrieval latency in ms")
    p95_retrieval_latency_ms: float = Field(default=0.0, description="p95 retrieval latency in ms")
